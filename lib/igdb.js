...
// rótulo do tipo — DLC e expansão não são descartadas (o catálogo pode incluí-las),
// mas precisam estar visíveis para não serem adicionadas como se fossem o jogo base
const TYPE_LABELS = {
  1: "DLC",
  2: "expansão",
  3: "pacote",
